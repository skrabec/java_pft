...
public class ContactHelper extends HelperBase {
  ...
  public void create(ContactData contact, ContactData photo, boolean creation) {
    initContactCreation();
    fillContactForm(contact, photo, creation);
    submitContactCreation();
    contactCache = null;
  }

  private void fillContactForm(ContactData contactData, ContactData photo, boolean creation) {
